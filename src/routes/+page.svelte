...
<main class="h-screen">
	...
	{:else if $media.landscape === false}
		...
		<p class="font-semibold my-7">newty<button class="text-green cursor-pointer inline" on:click={mouse => mouse.button === 0 ? shift_colour() : shift_colour(true)} tabindex={-1} style="color: {colour};">.dev</button></p>
